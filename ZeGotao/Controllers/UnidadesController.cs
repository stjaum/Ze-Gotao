...
namespace ZeGotao.Controllers
{
    public class UnidadesController : Controller
    {
        ...
        public UnidadesController(ZeGotaoContext context)
        {
            _context = context;
        }
        // GET: Unidades
        ...
        public async Task<IActionResult> Create([Bind("IdUnidade,NomeUnidade,Endereco,Telefone")] Unidade unidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUnidade,NomeUnidade,Endereco,Telefone")] Unidade unidade)
        {
        ...
        {
            return _context.Unidade.Any(e => e.IdUnidade == id);
        }
    }
}
