...
namespace ZeGotao.Migrations
{
    ...
    public partial class seedUsuario : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"INSERT INTO Usuario 
(Nome, Email, Senha, Cpf, Telefone, Endereco, DataNascimento, TipoUsuarioId, Ativo) VALUES 
('João da Silva', 'joao.silva@email.com', 'senha123', '111.222.333-44', '11987654321', 'Rua das Flores, 101', '1990-05-12', 2, 0),
